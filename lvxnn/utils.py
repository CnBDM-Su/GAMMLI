...
def plot_trajectory(data_dict_logs, log_scale=True, save_eps=False, save_png=False, folder="./results/", name="trajectory_plot"):
    ...
    if len(t4) > 0:
        ax1.annotate("Prune \n Interactions", ((len(t1 + t2 + t3) + 1), (t1 + t2 + t3)[-1]), xycoords="data",
                ...
                horizontalalignment="center", verticalalignment="top")
    if len(t5) > 0:
        ax1.annotate("Add \n Latent Effect", ((len(t1 + t2 + t3 + t4) + 1), (t1 + t2 + t3 + t4)[-1]), xycoords="data",
                xytext=(offset4x, offset4y), textcoords="offset pixels", arrowprops=dict(facecolor="black", shrink=0.1), fontsize=10,
                horizontalalignment="center", verticalalignment="top")
    ax1.legend(["Stage 1: Training Main Effects", "Stage 2: Training Interactions", "Stage 3: Training Latent Effects"])
    ...
    if len(v4) > 0:
        ax2.annotate("Prune \n Interactions", ((len(v1 + v2 + v3) + 1), (v1 + v2 + v3)[-1]), xycoords="data",
                ...
                horizontalalignment="center", verticalalignment="top")
    if len(v5) > 0:
        ax2.annotate("Add \n Latent Effect", ((len(v1 + v2 + v3 + v4) + 1), (v1 + v2 + v3 + v4)[-1]), xycoords="data",
                xytext=(offset4x, offset4y), textcoords="offset pixels", arrowprops=dict(facecolor="black", shrink=0.1), fontsize=10,
                horizontalalignment="center", verticalalignment="top")
    ax2.legend(["Stage 1: Training Main Effects", "Stage 2: Training Interactions", "Stage 3: Training Latent Effects"])
    plt.show()
