...
def lvxnn(wc, train, test, tr_x, val_x, tr_y, val_y, tr_Xi, val_Xi, tr_idx, val_idx, meta_info, model_info, task_type="Regression", val_ratio=0.2, random_state=0,params=None):
